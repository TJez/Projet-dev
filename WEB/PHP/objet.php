...
if (!isset($_POST["ID"])) {
  $requete = "SELECT id , nom , latitude , longitude , latitude_2 , longitude_2 , zoom_min , icone , type , indice , temps2 , indice2 , temps3 , indice_final , depart , bloque_par , suivant FROM objet ORDER BY id";
  $array=[];
